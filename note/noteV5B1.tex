...
\begin{theorem}
  If the domain is convex in the above then the Poincaré equation is solvable. (ie. all the de Rham cohomologies are $r=0$ except the $0$ term.)
  \par Furthermore,
  \begin{equation*}
    Z^r = \{f\in E^r\sep df = 0\}, B^r = \{du\sep u\in E^{r-1}\}.
  \end{equation*}
