...
\begin{definition}
  ...
  \par In that case $\mathscr{V}$ is called a refinement of $\mathscr{U}$. We furthere define a refinement map which is a map $\varphi:J\to I$ such that $V_{j}\subseteq U_{\varphi(i)}$.
\end{definition}

\begin{definition}
  Let $\sU,\sV$ be open covering of a topological space $X$ and $a\in\cC^q(\sU,\cA)$. Supposer $\sV$ is a refinement of $\sU$ with a refinement map $\phi:J\to I$. Then we define,
  \begin{equation*}
...
\begin{corollary}
  Suppose we are given $c\in Z^1(\sU,\cA)$, a cocycle. Under a refinement map $\varphi$, we have $\varphi^1c\in Z^1(\sV,\cA)$. 
\par If $\varphi^1c=\delta b$ for some $b\in\cC^0(\sV,\cA)$, then there is $\tilde{b}\in\cC^0(\sU,\cA)$ such that $\delta\tilde{b}=c$.
\end{corollary}
...
\begin{definition}
  Let $\mathscr{S}$ be a set of open covering of $X$ such that for any open covering $\sU$ of $X$, there is a refinement $\sV$ of $\sU$ contained in $\mathscr{S}$. We then define the inductive limit,
  \begin{equation*}
    H^\bullet(X,\mathcal{A}) = \varinjlim_{\substack{\sU\\\text{open covering}}}H^\bullet(\sU,\cA),
  \end{equation*}
  such that for each $\sU\in\mathscr{S}$, there is a well-define morphism,
  \begin{equation*}
    h^\bullet(\sU):H^\bullet(\sU,\cA)\to H^\bullet(X,\mathcal{A}),
  \end{equation*}
  such that for any refinement map $\varphi:\sV\to\sU$, we have a commutative diagram,
  \begin{center}
    \begin{tikzcd}
...
\end{tikzcd}
  ...
  \begin{equation*}
    \exists b\in\cC^{q-1}(\sU'',\cA),\delta b = h(\sU,\sU'')c-h(\sU',\sU'')c'.
  \end{equation*}
\end{definition}
...
\begin{proposition}
  If $\hat{\alpha}$ is injective then so is $\alpha$.
...
\end{tikzcd}
  ...
  \begin{definition}
    A sheaf of abelian group $\cA$ is acyclic if $H^q(X,\A)=0$ for all $q\geq1$.
  \end{definition}
  ...
  \begin{definition}
    ...
    \begin{center}
      \begin{tikzcd}
0 \arrow[r] & \cA \arrow[r, "h"] & \cA^0 \arrow[r, "h^0"] & \cA^1 \arrow[r, "h^1"] & \cA^2 \arrow[r] & {}
\end{tikzcd}
    \end{center}
  ...
  \begin{center}
    \begin{tikzcd}
0 \arrow[r] & \cA(X) \arrow[r, "h_X"] & \cA^0(X) \arrow[r, "h^0_X"] & \cA^1(X) \arrow[r, "h^1_X"] & \cA^2(X) \arrow[r] & {}
\end{tikzcd}
  \end{center}

  This is no longer an exact sequence. Thus we consider a cohomology of $\A^0(X)$.
...
\end{equation*}
  \end{proof}
  \subsection{deRahm and Dolbeault Theorems}
